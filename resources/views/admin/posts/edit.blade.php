                         ...
                         <div class="form-group">
                                <label for="exampleInputEmail1">Post Category:</label>
                                  @if(!empty($post_cat))
                                    ...
                                    <?php 
                                      $post_cat = explode(",", $post->post_category);
                                    //$cname=$cat->name == $post->post_category ? 'checked' : '';
                                      $cname ='';
                                      if(in_array($cat->name, $post_cat)){
                                        $cname = 'checked';
                                      } ?>
                                      <input type="checkbox" {{ $cname }} name="post_category[]"  value=" {{ $cat->name }}"> {{ $cat->name }}
                                    @endforeach
                                  @endif
                                </select>
                            </div>
