...
<div class="container">
    <div class="row">
        <div class="col-sm-12">
        <h1 class="et_pb_text_0">FIT INDIA SCHOOL REGISTRATION</h1>  
    </div>
    </div>
 <div class="row">              
    <div class="col-md-8">
    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
        ...
        <div class="panel panel-default ">
            ...
            <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                <div class="panel-body">
                   ...
                   <ol style=" padding-left: 15px;">
                    <li>All teachers to be physically ﬁt and spending 60 minutes or more every day for physical activities.</li>
                    <li>School has at least two trained teachers (including one PET), each well versed with any two sports.</li>
                    <li>Sports facilities for 4 sports including the 2 outdoor sports.</li>
        ...
        <div class="panel panel-default ">
          ...
          <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
              <div class="panel-body">
                 ...
                 <ol style=" padding-left: 15px;">
                  <li>School conducts monthly intra-school sports competitions, participates in inter-school sports competition and celebrates Annual Sports Day.</li>
                  <li>All teachers are trained in PE.</li>
                  <li>School has 2 or more sports coaches. These may be PE teachers.</li>
                  <li>School follows structured PE curriculum prescribed by NCERT/ School Board.</li>
                  <li>School conducts annual fitness assessment of all children.</li>
                  <li>School opens its playground(s) after school hours for neighbouring communities, and the same is actively used. Reasonable fee can be levied for maintenance and security.</li>
                </ol>
                </div>
          </div>
      </div>
      ...
      <div class="panel panel-default lastpanel">
        ...
        <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
            <div class="panel-body">
               <p>Procedure for Schools to get Fit India Star Certification</p> 
               <ol style=" padding-left: 15px;">
              ...
              <table border="0" width="100%" class="table-grid">
                ...
                <td><strong>Ekta Vishnoi</strong><br> Mission Director Fit India</td>
                </tr>
                </tbody>
                </table>
            </div>
            <div>Any query may be sent to <a href="mailto:contact.fitindia@gmail.com">contact.fitindia@gmail.com</a></div>
        </div>
    </div>
      ...
      <script type="text/javascript">
        ...
        function chkorganise(){
          var agree = document.getElementById('agreed');
            ...
            window.location='fit-india-school-certification'; 
            }
        }
