@extends('layouts.app')
@section('title', 'Champion | Fit-India ')
@section('content')
<section>
 ...
 <div class="container">
   @if(session('success'))
      ...
      <h2>Be a Fit India Champion</h2>       
          <form name="championform" method="post" action="champ-store" enctype="multipart/form-data">
            @csrf
            <div class="row">
                  ...
                  <div class="col-sm-12 col-md-6">
                    <div class="form-group">
                    <label for="description">Why do you want to become a Fit India Champion:-</label>
                ...
                <div class="col-sm-12 col-md-12">
                  <br>
                <div class="form-group">
                      <a style="color:black!important" class="champ_btn" href="{{ asset('wp-content/uploads/2021/01/Guidelines-for-Fit-India-Champion.pdf') }}" target="_blank">Guidelines of Fit India Champion</a>
                  </div>
                  </div>
...
<script>
  $(function() {
    ...
    $("form[name='championform']").validate({
      rules: {
        name:{
          required:true,
          lettersonly:true
    ...
    submitHandler: function(form) {
        ...
        if(follwer_sum > 100000){
            form.submit();
        }else{
            alert('Your social media counter greater than 100000');
        }
    }
  });
}); 
