...
@endphp
 <div class="banner_area1">
   <img src="{{ asset('resources/imgs/school-week.jpg') }}" alt="about-fitindia" class="img-fluid expand_img"/>        
...
<div class="container">
   <div class="row">
    ...
    <a class="freedombtn3" href="{{ url('wp-content/uploads/2021/01/How-to-Register.pdf') }}" target="_blank">How To Register</a> 
   </div><br>
    <div class="row">
        <div class="col-sm-12">
