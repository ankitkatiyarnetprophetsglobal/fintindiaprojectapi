                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control @error('roleid') is-invalid @enderror" name="roleid" id="roleid" required autocomplete="roleid" autofocus>
                                    <option value="">{{'Select'}}</option>
                                    @foreach ($roles as $role)
                                    <option value="{{ $role->id }}"  @if(old('roleid') == $role->id) {{ 'selected' }} @endif >{{ Str::upper($role->name)}}</option>
                                    @endforeach
                                </select>
                                @error('roleid')
